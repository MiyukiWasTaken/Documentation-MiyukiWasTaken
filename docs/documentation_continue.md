...
J'ai modifié et renommer toutes mes images afin de les rendres plus explicites grâce à Paint pour les modifications simple comme un rectangle en rouge pour encadrer un bouton, et GIMP pour les modifications plus complexes ou précises comme pour la colorisation non-opaque d'une zone avec des reliefs, notamment visible sur la photo dans [***`l'onglet sécurité`***](https://miyukiwastaken.github.io/Documentation-MiyukiWasTaken/xTool%20P3/securite.html). Je continues de travailler sur la rédation et j'ajuste des détails au fur et à mesure. Test d'insertion d'une image dans securite.md et dans fonctionnement.md, suivie par une erreur d'affichage.
